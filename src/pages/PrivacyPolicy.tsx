...
const PrivacyPolicy = () => {
  return (
    <div style={{ padding: '20px', lineHeight: 1.6, color: '#444444', display: 'flex', justifyContent: 'center', alignItems: "center", backgroundColor: '#F8FAFC' }}>
      <div style={{width: "80%", boxShadow: "2px", backgroundColor: "#fff", padding: 50}}>
        <h2 style={{fontSize: 32}}>Política Privacidade</h2>
        
        <p>A sua privacidade é importante para nós. É política do Irko respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="">Irko</a>, e outros sites que possuímos e operamos.</p>
        ...
        <p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas&nbsp;
          <a href="https://politicaprivacidade.com/" rel="noopener noreferrer" target="_blank" style={{ color: '#444444' }}>políticas de privacidade</a>.
        </p>
        ...
        <h3 style={{marginTop: 10}}>Compromisso do Usuário</h3>
        
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Irko oferece no site e com caráter enunciativo, mas não limitativo:</p>
        ...
        <ul>
          ...
          <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Irko, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
        ...
        <p>Esta política é efetiva a partir de 2 December 2025 16:25</p>
      </div>
    </div>
  );
};
